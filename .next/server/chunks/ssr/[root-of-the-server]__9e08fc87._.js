...
const firebaseConfig = {
    ...
    storageBucket: "skyfall-5e47d.appspot.com",
...
const AuthProvider = ({ children })=>{
        ...
        try {
            ...
            if (error.code === 'auth/user-cancelled' || error.code === 'auth/popup-closed-by-user') {
                toast({
                    ...
                    description: "The sign-in process was not completed.",
                    variant: "default"
                });
            } else {
                toast({
    ...
    const signInAnonymously = async (pseudo)=>{
        setLoading(true);
        try {
            const usersRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'users');
            const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(usersRef, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('username', '==', pseudo));
            const querySnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])(q);
            if (!querySnapshot.empty) {
                toast({
                    title: "Login Failed",
                    description: "This pseudo is already taken. Please choose another.",
                    variant: "destructive"
                });
                setLoading(false);
                return;
            }
            const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a1__as__signInAnonymously$3e$__["signInAnonymously"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"]);
            ...
            setUser(newUserProfile);
            toast({
                title: "Logged in as guest successfully!"
            });
        } catch (error) {
    ...
    const updateUserHighScore = async (score)=>{
        if (user) {
        ...
        try {
            if (data.newAvatarFile) {
                ...
                if (!response.ok) {
                    ...
                    return {
                        success: false,
                        message: errorData.error?.message || "Avatar upload failed."
                    };
                }
                ...
                if (cloudinaryData.secure_url) {
                    ...
                    return {
                        success: false,
                        message: "Avatar upload succeeded but URL was not returned."
                    };
                }
            }
            if (trimmedUsername && trimmedUsername !== user?.username) {
                ...
                const usersRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'users');
                const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(usersRef, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('username', '==', trimmedUsername));
                const querySnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])(q);
                if (!querySnapshot.empty) {
                    let conflict = false;
            ...
            if (Object.keys(authProfileUpdates).length > 0 || trimmedUsername && trimmedUsername !== user?.username || newPhotoURL !== undefined) {
                ...
                if (!currentUser.isAnonymous && Object.keys(authProfileUpdates).length > 0) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$18137433$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__al__as__updateProfile$3e$__["updateProfile"])(currentUser, authProfileUpdates);
                }
                ...
                setUser((prevUser)=>{
                    ...
                    return {
                        ...prevUser,
                        ...trimmedUsername && trimmedUsername !== prevUser.username ? {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e08fc87._.js.map