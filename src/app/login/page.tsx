...
const GoogleGLogo = () => (
  <svg width="100%" height="100%" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 20 C 20 10, 80 10, 80 20 C 80 30, 20 30, 20 20" fill="#ea4335" />
    <path d="M20 20 C 20 80, 80 80, 80 20" fill="#fbbc05" />
    <path d="M20 80 C 20 90, 80 90, 80 80 C 80 70, 20 70, 20 80" fill="#34a853" />
    <path d="M20 80 C 20 20, 80 20, 80 80" fill="#4285f4" />
  </svg>
);
