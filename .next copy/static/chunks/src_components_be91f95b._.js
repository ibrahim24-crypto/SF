...
const GameHeader = ({ score, highScore, livesState })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: "absolute top-0 left-0 right-0 z-10 flex items-start justify-between p-4",
        children: [
...
const GameScreen = ()=>{
    ...
    const livesDisplayRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // This ref might be repurposed or used by GameHeader if needed
    ...
    const handleBallMiss = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GameScreen.useCallback[handleBallMiss]": (ballId)=>{
            ...
            setMissedBallStreak({
                "GameScreen.useCallback[handleBallMiss]": (mbs)=>{
                ...
                "GameScreen.useEffect.gameLoop": ()=>{
                    ...
                    setBalls({
                        "GameScreen.useEffect.gameLoop": (prevBalls)=>prevBalls.map({
                            ...
                            }["GameScreen.useEffect.gameLoop"]).filter(Boolean) // Ensure type after filter
                    }["GameScreen.useEffect.gameLoop"]);
                    animationFrameId = requestAnimationFrame(gameLoop);
                }
            }["GameScreen.useEffect.gameLoop"];
...
_s(GameScreen, "NBht+k7pjxvcLaSaY+ZMpSvAlVI=");
_c = GameScreen;
...
//# sourceMappingURL=src_components_be91f95b._.js.map